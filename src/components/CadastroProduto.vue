...
<template>
    ...
    <form @submit.prevent="cadastrar">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" v-model="produto.descricao" required />
        </div>
        <div class="form-group">
            <label class="form-label">Preço</label>
            <div class="input-group">
                <span class="input-group-text">R$</span>
                <input type="number" min="0" step="0.01" class="form-control"  v-model="produto.preco" required>
            </div>
        </div>
        <br>
        <div class="row">
